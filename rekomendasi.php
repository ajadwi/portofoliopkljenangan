  ...
  <div id="container">
    <div id="header">
      <div class="headerBackground">
        <h1><font color="#f8192e"><br><br><b>&nbsp;&nbsp;Uwais Book</font><font color="#ffffff"> Store</font></b></h1>
      </div>
    </div>
  <body>
            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                   <img src="img/store.png" width="128px" height="128px"><br>
                    <h1><b><font color="#f8192e">Uwais Book</font> Store</b></h1>
...
<!-- Bagian footer -->
    ...
    <div class="row" style="background: black;">
      <nav class="footer">
            <footer class="copyright text-center"><p>&copy; Copyright Uwais Book Store 2020</p></footer>
        </div>
      </nav>
    </div>
</body>
